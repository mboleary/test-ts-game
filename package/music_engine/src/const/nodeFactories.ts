...
import { MusicEngineOscillatorNode, MusicEngineSamplerNode, SerializedMusicEngineOscillatorNode, SerializedMusicEngineSamplerNode } from "../nodes";
...
type FactoryMap = 
    ...
    NodeFactory<MusicEngineSamplerNode, SerializedMusicEngineSamplerNode>;
...
export const nodeFactories: FactoryMap[] = [
    ...
    {name: MusicEngineSamplerNode.type, build: MusicEngineSamplerNode.fromJSON}
]